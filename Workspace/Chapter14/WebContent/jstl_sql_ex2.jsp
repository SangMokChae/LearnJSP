...
<body>
	...
	<sql:transaction dataSource="${conn }" isolation="read_committed" /> <!-- transaction 실행 -->
	...
	<sql:update dataSource="${conn }"> insert into test (num, name) values(10, '조준동') </sql:update>
	<sql:update dataSource="${conn }"> insert into test (num, name) values(11, '홍길동') </sql:update>
